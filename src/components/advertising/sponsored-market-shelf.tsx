    ...
    <section className="relative rounded-surface border border-action-primary/25 bg-surface-raised p-4 pt-10 shadow-card">
      ...
      <div className="flex items-end justify-between gap-4">
        <div className="min-w-0">
          <Link href={decision.creative.landing_url} onClick={onNavigate} className="text-xl font-bold hover:text-action-primary focus-visible:outline focus-visible:outline-2 focus-visible:outline-brand">{market.name}</Link>
