...
export const buttonVariants = cva(
  "inline-flex shrink-0 min-h-11 cursor-pointer items-center justify-center gap-2 rounded-control px-4 text-sm font-bold transition-[background-color,border-color,color,box-shadow,transform] duration-[var(--commerce-motion-normal)] ease-[var(--commerce-ease-out)] not-disabled:active:scale-[0.98] disabled:cursor-not-allowed disabled:opacity-45",
  {
    variants: {
      variant: {
