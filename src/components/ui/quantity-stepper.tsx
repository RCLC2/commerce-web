...
export function QuantityStepper({ value, min = 1, max, disabled = false, onValueChange, className, label = "수량" }: { value: number; min?: number; max?: number; disabled?: boolean; onValueChange: (value: number) => void; className?: string; label?: string }) {
