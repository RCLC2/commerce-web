export const queryKeys = {
  ...
  wishlist: (token: string | null | undefined) => ["me-wishlist", token] as const,
  likedProducts: (token: string | null | undefined) => ["me-liked-products", token] as const,
  marketFollow: (marketID: number, token: string | null | undefined) => ["market-follow", marketID, token] as const,
  myReviews: (token: string) => ["me-reviews", token] as const,
